            ...
            <div className="relative">
              <div className="aspect-[4/5] bg-gray-100 rounded-lg overflow-hidden relative">
                <div className={`absolute inset-0 bg-gradient-to-br ${
                  isDarkMode ? 'from-blue-900 via-pink-900' : 'from-blue-100 via-pink-100'
              ...
              <div className="flex flex-wrap gap-2">
                {skills.map((skill, index) => (
                  <span
                    ...
                    } border shadow-sm rounded-md text-xs font-medium tracking-wide hover:border-gray-300 transition-all duration-200 transform hover:scale-105 flex items-center justify-center`}
                  >
                    {skill.name}
                  </span>
                ))}
